 ...
 ******************************************************************************/
package edu.kit.scc.regapp.service.timer;
...
public class ClusterSingletonTimerService implements Service<ClusterScheduler> {
    ...
    private ClusterScheduler lookupClusterScheduler() throws NamingException {
        ...
        return (ClusterScheduler) ic.lookup("global/reg-app/reg-app-service/ClusterSchedulerImpl!edu.kit.scc.regapp.service.timer.ClusterScheduler");
