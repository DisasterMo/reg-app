...
public class ServiceRegisterSendMailExecutor extends
	...
	public void execute() {
		...
		try {
			...
			TemplateMailService templateMailService = (TemplateMailService) ic.lookup("global/reg-app/reg-app-service/TemplateMailServiceImpl!edu.kit.scc.regapp.service.mail.TemplateMailService");
