...
import edu.kit.scc.regapp.audit.AuditEntryService;
...
public class ClearAuditLogs extends AbstractExecutableJob {
	...
	public void execute() {
		...
		try {
			...
			AuditEntryService auditEntryService = (AuditEntryService) ic.lookup("global/regapp/regapp-service/AuditEntryServiceImpl!edu.kit.scc.regapp.audit.AuditEntryService");
