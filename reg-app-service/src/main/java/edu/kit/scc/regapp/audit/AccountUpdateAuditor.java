...
import edu.kit.scc.regapp.entity.audit.AuditAccountUpdateEntity;

public class AccountUpdateAuditor extends AbstractAuditor<AuditAccountUpdateEntity> {

	private static final long serialVersionUID = 1L;

	public AccountUpdateAuditor(AuditEntryDao auditEntryDao,
	...
	public void setAccount(AccountEntity entity) {
		audit.setAccount(entity);
	}

	@Override
	protected AuditAccountUpdateEntity newInstance() {
		return new AuditAccountUpdateEntity();
	}
}
