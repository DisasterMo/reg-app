...
public class SshConnector {
    ...
    **/
    public String sendInput(String command, String host, String user, String privateKeyFilepath, String privateKeyPassword, String knownHostsFilepath) {
     ...
     * @return Any output or errors from the host as a single string.
    **/
    public String setPassword (String userName, String userPassword, String host, String user, String privateKeyFilepath, String privateKeyPassword, String knownHostsFilepath)
    {
